...
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        <h3 class="font-headline text-3xl font-extrabold text-on-surface tracking-tight">Tambah Siswa Baru</h3>
        <p class="text-on-surface-variant mt-1">Isi formulir di bawah untuk mendaftarkan siswa baru beserta akun loginnya.</p>
    </div>
...
<div class="bg-surface-container-lowest rounded-[2rem] overflow-hidden">
    <div class="p-8 bg-white/40 backdrop-blur-sm border-b border-surface-container-high">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h4 class="text-xl font-headline font-bold">Formulir Pendaftaran</h4>
                <p class="text-xs text-on-surface-variant">Data akun & profil siswa</p>
            </div>
        </div>
    </div>
