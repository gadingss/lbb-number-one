            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="durasi_pertemuan" value="{{ old('durasi_pertemuan', 90) }}" placeholder="Contoh: 90" class="w-full bg-slate-50 border-none rounded-xl pl-12 pr-4 py-3 focus:bg-white focus:ring-2 focus:ring-blue-500/20 transition-all font-medium text-slate-700" required>
                    </div>
                </div>
