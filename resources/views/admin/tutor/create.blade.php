...
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        <h3 class="font-headline text-3xl font-extrabold text-on-surface tracking-tight">Tambah Tutor Baru</h3>
        <p class="text-on-surface-variant mt-1">Isi formulir di bawah untuk mendaftarkan pengajar baru beserta akun loginnya.</p>
    </div>
...
<div class="bg-surface-container-lowest rounded-[2rem] overflow-hidden">
    <div class="p-8 bg-white/40 backdrop-blur-sm border-b border-surface-container-high">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h4 class="text-xl font-headline font-bold">Formulir Pendaftaran Tutor</h4>
                <p class="text-xs text-on-surface-variant">Data akun & profil pengajar</p>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.tutor.store') }}" method="POST" class="p-8">
        @csrf
        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="block mb-2 text-xs font-bold text-on-surface-variant uppercase tracking-wider">Password Akun Baru</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                        ...
                        placeholder="Alamat lengkap pengajar" required>{{ old('alamat') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="kuota_siswa" value="{{ old('kuota_siswa', 5) }}" min="1"
                        class="w-full bg-surface-container-highest border-none rounded-xl p-3 text-sm font-medium text-on-surface focus:ring-2 focus:ring-primary focus:bg-surface-container-lowest transition-all"
