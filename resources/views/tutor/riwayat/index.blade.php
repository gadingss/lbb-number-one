...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl sm:text-3xl font-headline font-extrabold text-on-surface">Riwayat Mengajar</h2>
            <p class="text-on-surface-variant font-medium mt-1">Daftar seluruh pertemuan yang telah Anda laksanakan.</p>
        </div>
